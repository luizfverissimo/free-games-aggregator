...
const Home = () => (
  <main className='w-full flex flex-col items-center font-mont text-theme-white'>
    ...
    <section className='w-full max-w-[1440px] flex flex-col items-center my-8'>
      ...
      <h2 className='mt-8 font-bold text-2xl'>Watch out for new free games:</h2>
      ...
      <Button className='max-w-max px-6 mt-12 font-bold text-2xl '>Load more free game ↓</Button>
    </section>
    <Footer/>
  </main>
);
